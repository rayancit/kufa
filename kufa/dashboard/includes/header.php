                        ...
                        <div class="d-flex">
                            <ul class="navbar-nav">
                                <li class="nav-item hidden-on-mobile">
                                    <a class="nav-link btn btn-info text-white" href="kufa/../../frontend/index.php" target="_blank">visit site</a>
                                </li>
                                <li class="nav-item hidden-on-mobile">
                                    <a class="nav-link btn btn-danger text-white" href="dashboard/../auth/logout.php">logout</a>
                                </li>
                                <!-- <li class="nav-item hidden-on-mobile">
