    ...
    <div class="app-auth-container">
        ...
        <div class="auth-credentials m-b-xxl">
            <form action="./signup_data.php" method="post">
                ...
                <input type="text" class="form-control m-b-mdn <?= isset($_SESSION['email_error']) ? 'is-invalid' : '' ?>" id="signUpEmail" aria-describedby="signUpEmail" placeholder="example@neptune.com" name="user_email" value="<?= isset($_SESSION['old_email']) ? $_SESSION['old_email'] : '';unset($_SESSION['old_email']); ?>">
                <?php
